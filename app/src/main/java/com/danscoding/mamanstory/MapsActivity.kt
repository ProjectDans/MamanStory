...
import com.danscoding.mamanstory.databinding.ActivityMapsBinding
import com.danscoding.mamanstory.viewmodel.MapsViewModel
    ...
    private val requestPermissionLauncher =
        registerForActivityResult(
            ...
            if (isGranted) {
                ...
                Toast.makeText(this, getString(R.string.app_permission_warning), Toast.LENGTH_SHORT).show()
            }
        }
